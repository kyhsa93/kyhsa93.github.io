...
export const uiCopy: Record<Locale, UiCopy> = {
  ...
  ko: {
    ...
    privacyPolicy: {
      ...
      advertisingBody1:
        '이 사이트는 Google AdSense를 통해 광고를 표시합니다. Google과 파트너사는 이 사이트 또는 다른 사이트에서의 이전 방문 기록을 바탕으로 쿠키 및 유사 기술을 사용해 광고를 제공할 수 있습니다. 다음 페이지를 방문해 맞춤 광고를 거부할 수 있습니다:',
      adSettingsLink: 'Google 광고 설정',
      advertisingBody2:
      '. 또는 이 사이트의 쿠키 배너에서 거부를 선택할 수 있으며, 이 경우 이후 방문 기간 동안 광고 스크립트 자체가 로드되지 않습니다.',
